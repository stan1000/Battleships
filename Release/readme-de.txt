...
Einstellungsdateien:
config.htm		Texte für alle Ausgaben in Applikation und Dediziertem Server, und einige weitere Einstellungen für die Applikation
server.cfg		- Generelle Spielkonfiguration für Applikation und Dedizierten Server
